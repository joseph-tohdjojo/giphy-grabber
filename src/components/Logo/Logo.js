  ...
  <div className={className}>
    ...
    >
      <g className="logo-icon" fillRule="evenodd" clipRule="evenodd">
        <path className={styles.green} d="M0 3h4v29H0z" />
        <path className={styles.purple} d="M24 11h4v21h-4z" />
        <path className={styles.blue} d="M0 31h28v4H0z" />
        <path className={styles.yellow} d="M0 0h16v4H0z" />
        <path className={styles.red} d="M24 8V4h-4V0h-4v12h12V8" />
        <path className={styles.shadow} d="M24 16v-4h4M16 0v4h-4" />
      </g>
